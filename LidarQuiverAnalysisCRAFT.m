...
ptCloud1_pol_dr_shad = conv_to_polar(ptCloud1_shad_domrem, initial_o);
ptCloud2_pol_dr_shad = conv_to_polar(ptCloud2_shad_domrem, initial_o);
...
figure(7)
quiver3(X_q_shad_dr, Y_q_shad_dr, Z_q_shad_dr, U_q_shad_dr, V_q_shad_dr, W_q_shad_dr, 'AutoScale', 'off')
title("Vector Plot with domain boundary errors removed and shadow mitigation")
